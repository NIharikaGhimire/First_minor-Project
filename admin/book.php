				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						while($row=$movie->fetch_assoc()){
						 ...
						 <tr>
						 	<td><?php echo $i++ ?></td>
						 	 <!-- <td><?php echo ucwords($row['lastname'].', '.$row['firstname']) ?> -->
						 	 	<td><?php echo ucwords($row['username'])?>

						 	<td><?php echo $row['contact_no'] ?></td>
						 	<td><?php echo $row['title'] ?></td>
						 	<td>
						 		<p><small><b>Theater:</b> <?php echo $row['theater'] ?></small></p>
						 		<p><small><b>Seat Group:</b> <?php echo implode(", ",json_decode($row['is_booked'])) ?></small></p>
